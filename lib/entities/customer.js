BarFiller.entities.customer = function(drink_name) {
  ...
  BarFiller.customer_components.mood.apply(this);
  
  this.drink_name = drink_name;
  // Dummy value, replaced shortly
  this.character = "\uD83C\uDF7A";
  ...
  this.mood_renderer = new BarFiller.renderers.mood(this);
  ...
  this.click_action = function() {
    if (this.drink_name == 'no_drink') {
      console.log("This customer doesn't want a drink");
      this.enrage();
    } else {
